...
$qry="update tbl_cartmaster set cart_status='booked' where uname='$uname'";
mysqli_query($con,$qry);

$dat= date('Y-m-d');;
$cid=$_SESSION["cid"];
$qry1="insert into tbl_booking(`cmaster_id`,`bookingdate`) values('$cid','$dat')";
                ...
                <td>
                    <table class="auto-style1">
                        ...
                        <!-- <tr>
                            ...
                            <td class="auto-style37"></td>
                            <td class="auto-style38">&nbsp; <asp:Label ID="lblTID" runat="server">000000</asp:Label>
                            </td>
                        </tr> -->
                        <tr>
